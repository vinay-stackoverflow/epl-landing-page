const translations = {
  en: {
    ...
    about: {
      ...
      p1: 'Welcome back to the EPL — the most awaited tournament of the year! Season 8 is here, and it\'s set to be bigger, bolder, and more exciting than ever before.',
      ...
      h3: 'Season 8', p_h3: 'The most awaited edition of the EPL is finally here',
    },
    ...
    program: {
      title: 'Event Program',
      subtitle: '20th June · Yelahanka Office \u00a0|\u00a0 27th & 28th June · VKCA, Yelahanka',
      imageLabel: '🏏 Season 8 · VKCA, Yelahanka',
      schedule: [
        {
          time: '20 Jun · Yelahanka Office',
          title: 'Player Auction — Bidding Session',
          description: 'The grand auction kicks off at the Yelahanka office! Over 150 players go under the hammer as team owners and captains battle it out to build their dream squads. Expect bidding wars, strategic picks, and nail-biting moments.',
          type: 'highlight',
        },
        {
          time: '27 Jun · VKCA',
          title: 'Opening Ceremony & Season 8 Kick-off',
          description: 'A grand opening ceremony to mark the start of EPL Season 8 at VKCA, Yelahanka. Prepare for an unforgettable cricketing experience.',
          type: 'ceremony',
        },
        {
          time: '27 Jun · VKCA',
    ...
    speakers: {
      ...
      list: [
        { name: 'Tournament Committee', title: 'Organising Team', company: 'EPL Season 8', bio: 'The dedicated team behind EPL Season 8, working tirelessly to make the tournament bigger and better every year.', initials: 'TC', color: '#f97316' },
        ...
        { name: 'EPL Players Pool', title: '150+ Registered Players', company: 'EPL Yelahanka', bio: 'Over 150 talented cricketers registered for Season 8, each waiting to hear their name called at the grand auction.', initials: 'PP', color: '#f59e0b' },
      ],
    },
    ...
    registration: {
      ...
      successMsg: 'Welcome to EPL Season 8! Auction is on 20th June, and matches are on 27th & 28th June 2026 at VKCA, Yelahanka. For any queries, contact us at',
    },

    // Footer
    footer: '© 2026 EPL Season 8 · For queries:',
  },
  ...
  te: {
    ...
    about: {
      ...
      p1: 'EPL కు స్వాగతం — సంవత్సరంలో అత్యంత ఆసక్తికరమైన టోర్నమెంట్! సీజన్ 8 వచ్చింది, మరియు ఇది గతంలో కంటే పెద్దదిగా మరియు మరింత ఉత్తేజకరంగా ఉంటుంది.',
      ...
      h3: 'సీజన్ 8', p_h3: 'EPL యొక్క అత్యంత ఆసక్తికరమైన సంచిక చివరికి వచ్చింది',
    },
    ...
    program: {
      ...
      subtitle: '20 జూన్ · యలహంక కార్యాలయం \u00a0|\u00a0 27 & 28 జూన్ · VKCA, యలహంక',
      imageLabel: '🏏 సీజన్ 8 · VKCA, యలహంక',
      schedule: [
        {
          time: '20 జూన్ · యలహంక కార్యాలయం',
          title: 'ఆటగాళ్ళ వేలం — బిడ్డింగ్ సెషన్',
          description: 'యలహంక కార్యాలయంలో గ్రాండ్ వేలం ప్రారంభమవుతోంది! 150 కంటే ఎక్కువ ఆటగాళ్ళు వేలానికి వస్తారు. వేల పోటీలు, వ్యూహాత్మక ఎంపికలు మరియు ఉత్కంఠభరితమైన క్షణాలను ఆశించండి.',
          type: 'highlight',
        },
        {
          time: '27 జూన్ · VKCA',
          title: 'ప్రారంభ వేడుక & సీజన్ 8 కిక్-ఆఫ్',
          description: 'VKCA, యలహంకలో EPL సీజన్ 8 ప్రారంభాన్ని గుర్తించే గ్రాండ్ ప్రారంభ వేడుక. మరచిపోలేని క్రికెట్ అనుభవానికి సిద్ధంగా ఉండండి.',
          type: 'ceremony',
        },
        {
          time: '27 జూన్ · VKCA',
    ...
    speakers: {
      ...
      list: [
        { name: 'టోర్నమెంట్ కమిటీ', title: 'నిర్వాహక బృందం', company: 'EPL సీజన్ 8', bio: 'EPL సీజన్ 8 వెనుక ఉన్న అంకితమైన బృందం, టోర్నమెంట్‌ను ప్రతి సంవత్సరం మరింత గొప్పగా చేయడానికి అవిశ్రాంతంగా పనిచేస్తోంది.', initials: 'TC', color: '#f97316' },
        ...
        { name: 'EPL ఆటగాళ్ళ జాబితా', title: '150+ నమోదైన ఆటగాళ్ళు', company: 'EPL యలహంక', bio: 'సీజన్ 8 కోసం 150 కంటే ఎక్కువ ప్రతిభావంతులైన క్రికెటర్లు నమోదు చేసుకున్నారు, గ్రాండ్ వేలంలో తమ పేరు పిలవబడాలని ఎదురుచూస్తున్నారు.', initials: 'PP', color: '#f59e0b' },
      ],
    },
    ...
    registration: {
      ...
      successMsg: 'EPL సీజన్ 8కు స్వాగతం! వేలం 20 జూన్‌న, మ్యాచ్‌లు 27 & 28 జూన్ 2026న VKCA, యలహంకలో జరుగుతాయి. ఏదైనా సందేహాల కోసం సంప్రదించండి',
    },

    // Footer
    footer: '© 2026 EPL సీజన్ 8 · సందేహాల కోసం:',
  },
  ...
  hi: {
    ...
    about: {
      ...
      p1: 'EPL में आपका स्वागत है — साल का सबसे प्रतीक्षित टूर्नामेंट! सीज़न 8 आ गया है, और यह पहले से कहीं ज़्यादा बड़ा और रोमांचक होने वाला है।',
      ...
      h3: 'सीज़न 8', p_h3: 'EPL का सबसे प्रतीक्षित संस्करण अंततः आ गया है',
    },
    banner: { label: 'EPL सीज़न 8 · लड़ाई शुरू होती है' },
    program: {
      title: 'इवेंट कार्यक्रम',
      subtitle: '20 जून · येलहंका कार्यालय \u00a0|\u00a0 27 और 28 जून · VKCA, येलहंका',
      imageLabel: '🏏 सीज़न 8 · VKCA, येलहंका',
      schedule: [
        { time: '20 जून · येलहंका कार्यालय', title: 'खिलाड़ी नीलामी — बोली सत्र', description: 'येलहंका कार्यालय में भव्य नीलामी शुरू होती है! 150 से अधिक खिलाड़ियों की बोली लगाई जाएगी। बोली युद्ध, रणनीतिक चुनाव और रोमांचक पलों की उम्मीद रखें।', type: 'highlight' },
        { time: '27 जून · VKCA', title: 'उद्घाटन समारोह और सीज़न 8 किक-ऑफ', description: 'VKCA, येलहंका में EPL सीज़न 8 की शुरुआत को चिह्नित करने वाला भव्य उद्घाटन समारोह। एक अविस्मरणीय क्रिकेट अनुभव के लिए तैयार हो जाइए।', type: 'ceremony' },
    ...
    speakers: {
      ...
      list: [
        { name: 'टूर्नामेंट समिति', title: 'आयोजन दल', company: 'EPL सीज़न 8', bio: 'EPL सीज़न 8 के पीछे समर्पित दल, जो टूर्नामेंट को हर साल बेहतर बनाने के लिए अथक परिश्रम करता है।', initials: 'TC', color: '#f97316' },
        ...
        { name: 'EPL खिलाड़ी पूल', title: '150+ पंजीकृत खिलाड़ी', company: 'EPL येलहंका', bio: 'सीज़न 8 के लिए 150 से अधिक प्रतिभाशाली क्रिकेटरों ने पंजीकरण कराया है, जो भव्य नीलामी में अपना नाम सुनने का इंतज़ार कर रहे हैं।', initials: 'PP', color: '#f59e0b' },
      ],
    },
    gallery: {
      title: 'पिछले सीज़न',
    ...
    registration: {
      ...
      successMsg: 'EPL सीज़न 8 में आपका स्वागत है! नीलामी 20 जून को और मैच 27 और 28 जून 2026 को VKCA, येलहंका में हैं। किसी भी प्रश्न के लिए संपर्क करें',
    },
    footer: '© 2026 EPL सीज़न 8 · प्रश्नों के लिए:',
  },

  sa: {
    nav: { title: 'EPL अष्टमः सत्रः', langLabel: 'संस्कृतम्' },
    hero: {
      badge: 'EPL · अष्टमः सत्रः',
      title: 'EPL अष्टमः सत्रः',
      subtitle: 'वर्षस्य सर्वाधिक प्रतीक्षितः क्रिकेट-प्रतियोगिता पुनरागतः!',
      date: '२७ जून २०२६',
      location: 'VKCA, येलहङ्का',
      registerHere: 'अत्र नामाङ्कनं कुरुत',
    ...
    about: {
      ...
      p1: 'EPL इत्यत्र स्वागतम् — वर्षस्य सर्वाधिक प्रतीक्षितः प्रतियोगिता! अष्टमः सत्रः समागतः, अयं पूर्वापेक्षया विशालतरः रोमाञ्चकतरश्च भविष्यति।',
      ...
      h3: 'अष्टमः सत्रः', p_h3: 'EPL इत्यस्य सर्वाधिक प्रतीक्षितः संस्करणः अन्ततः समागतः',
    },
    banner: { label: 'EPL अष्टमः सत्रः · युद्धम् आरभते' },
    program: {
      title: 'उत्सव-कार्यक्रमः',
      subtitle: '२० जून · येलहङ्का-कार्यालयः \u00a0|\u00a0 २७ & २८ जून · VKCA, येलहङ्का',
      imageLabel: '🏏 अष्टमः सत्रः · VKCA, येलहङ्का',
      schedule: [
        { time: '२० जून · येलहङ्का-कार्यालयः', title: 'क्रीडक-नीलामी — निविदा-सत्रम्', description: 'येलहङ्का-कार्यालये भव्यनीलामी आरभते! १५०+ क्रीडकाः नीलामे भविष्यन्ति। नीलाम-युद्धानि, रणनैतिक-चयनानि, रोमाञ्चकाः क्षणाश्च प्रतीक्षध्वम्।', type: 'highlight' },
        { time: '२७ जून · VKCA', title: 'उद्घाटन-समारोहः & अष्टम-सत्र-आरम्भः', description: 'VKCA येलहङ्कायाम् EPL अष्टम-सत्रस्य आरम्भं सूचयन् भव्योद्घाटन-समारोहः। अविस्मरणीयस्य क्रिकेट-अनुभवस्य कृते सज्जाः भवत।', type: 'ceremony' },
    ...
    speakers: {
      ...
      list: [
        { name: 'प्रतियोगिता-समितिः', title: 'आयोजन-दलम्', company: 'EPL अष्टमः सत्रः', bio: 'EPL अष्टम-सत्रस्य पृष्ठे समर्पितं दलम्, प्रतियोगितां प्रतिवर्षं श्रेष्ठतरां कर्तुं अनवरतं कार्यं करोति।', initials: 'TC', color: '#f97316' },
        ...
        { name: 'EPL क्रीडक-सञ्चयः', title: '१५०+ नामाङ्कितक्रीडकाः', company: 'EPL येलहङ्का', bio: 'अष्टम-सत्राय १५०+ प्रतिभाशालिनः क्रिकेटाः नामाङ्कनं कृतवन्तः, भव्यनीलामे स्वनाम श्रोतुमिच्छन्तः।', initials: 'PP', color: '#f59e0b' },
      ],
    },
    gallery: {
      title: 'पूर्व-सत्राणि',
    ...
    registration: {
      ...
      successMsg: 'EPL अष्टम-सत्रे स्वागतम्! नीलामी २० जून्, स्पर्धाश्च २७ & २८ जून २०२६ VKCA येलहङ्कायाम्। सम्पर्काय',
    },
    footer: '© २०२६ EPL अष्टमः सत्रः · जिज्ञासायाः कृते:',
  },
  ...
  kn: {
    ...
    about: {
      title: 'ಈವೆಂಟ್ ಬಗ್ಗೆ',
      p1: 'EPL ಗೆ ಸ್ವಾಗತ — ವರ್ಷದ ಅತ್ಯಂತ ನಿರೀಕ್ಷಿತ ಟೂರ್ನಮೆಂಟ್! ಸೀಸನ್ 8 ಬಂದಿದೆ, ಮತ್ತು ಇದು ಹಿಂದಿಗಿಂತ ದೊಡ್ಡದು ಮತ್ತು ರೋಮಾಂಚಕವಾಗಿರಲಿದೆ.',
      ...
      h3: 'ಸೀಸನ್ 8', p_h3: 'EPL ನ ಅತ್ಯಂತ ನಿರೀಕ್ಷಿತ ಆವೃತ್ತಿ ಅಂತಿಮವಾಗಿ ಬಂದಿದೆ',
    },
    banner: { label: 'EPL ಸೀಸನ್ 8 · ಯುದ್ಧ ಪ್ರಾರಂಭವಾಗುತ್ತದೆ' },
    program: {
      title: 'ಈವೆಂಟ್ ಕಾರ್ಯಕ್ರಮ',
      subtitle: '20 ಜೂನ್ · ಯಲಹಂಕ ಕಚೇರಿ \u00a0|\u00a0 27 & 28 ಜೂನ್ · VKCA, ಯಲಹಂಕ',
      imageLabel: '🏏 ಸೀಸನ್ 8 · VKCA, ಯಲಹಂಕ',
      schedule: [
        { time: '20 ಜೂನ್ · ಯಲಹಂಕ ಕಚೇರಿ', title: 'ಆಟಗಾರರ ಹರಾಜು — ಬಿಡ್ಡಿಂಗ್ ಸೆಶನ್', description: 'ಯಲಹಂಕ ಕಚೇರಿಯಲ್ಲಿ ಭವ್ಯ ಹರಾಜು ಪ್ರಾರಂಭವಾಗುತ್ತದೆ! 150ಕ್ಕೂ ಹೆಚ್ಚು ಆಟಗಾರರು ಹರಾಜಿಗೆ ಬರಲಿದ್ದಾರೆ. ಹರಾಜು ಸ್ಪರ್ಧೆಗಳು, ತಂತ್ರಗಾರಿಕೆ ಮತ್ತು ರೋಮಾಂಚಕ ಕ್ಷಣಗಳನ್ನು ನಿರೀಕ್ಷಿಸಿ.', type: 'highlight' },
        { time: '27 ಜೂನ್ · VKCA', title: 'ಉದ್ಘಾಟನಾ ಸಮಾರಂಭ ಮತ್ತು ಸೀಸನ್ 8 ಕಿಕ್-ಆಫ್', description: 'VKCA, ಯಲಹಂಕದಲ್ಲಿ EPL ಸೀಸನ್ 8 ಪ್ರಾರಂಭವನ್ನು ಗುರುತಿಸುವ ಭವ್ಯ ಉದ್ಘಾಟನಾ ಸಮಾರಂಭ. ಮರೆಯಲಾಗದ ಕ್ರಿಕೆಟ್ ಅನುಭವಕ್ಕೆ ಸಿದ್ಧರಾಗಿ.', type: 'ceremony' },
    ...
    speakers: {
      ...
      list: [
        { name: 'ಟೂರ್ನಮೆಂಟ್ ಸಮಿತಿ', title: 'ಆಯೋಜಕ ತಂಡ', company: 'EPL ಸೀಸನ್ 8', bio: 'EPL ಸೀಸನ್ 8 ಹಿಂದಿರುವ ಸಮರ್ಪಿತ ತಂಡ, ಟೂರ್ನಮೆಂಟ್ ಅನ್ನು ಪ್ರತಿ ವರ್ಷ ಉತ್ತಮಗೊಳಿಸಲು ಅವಿರತ ಶ್ರಮಿಸುತ್ತದೆ.', initials: 'TC', color: '#f97316' },
        ...
        { name: 'EPL ಆಟಗಾರರ ಸಂಗ್ರಹ', title: '150+ ನೋಂದಾಯಿತ ಆಟಗಾರರು', company: 'EPL ಯಲಹಂಕ', bio: 'ಸೀಸನ್ 8 ಗಾಗಿ 150ಕ್ಕೂ ಹೆಚ್ಚು ಪ್ರತಿಭಾವಂತ ಕ್ರಿಕೆಟರ್‌ಗಳು ನೋಂದಾಯಿಸಿದ್ದಾರೆ, ಭವ್ಯ ಹರಾಜಿನಲ್ಲಿ ತಮ್ಮ ಹೆಸರು ಕರೆಯಲ್ಪಡಲು ಕಾಯುತ್ತಿದ್ದಾರೆ.', initials: 'PP', color: '#f59e0b' },
      ],
    },
    gallery: {
    ...
    registration: {
      ...
      successMsg: 'EPL ಸೀಸನ್ 8 ಗೆ ಸ್ವಾಗತ! ಹರಾಜು 20 ಜೂನ್, ಮತ್ತು ಪಂದ್ಯಗಳು 27 & 28 ಜೂನ್ 2026 ರಂದು VKCA, ಯಲಹಂಕದಲ್ಲಿ. ಯಾವುದೇ ಪ್ರಶ್ನೆಗಳಿಗಾಗಿ ಸಂಪರ್ಕಿಸಿ',
    },
    footer: '© 2026 EPL ಸೀಸನ್ 8 · ಪ್ರಶ್ನೆಗಳಿಗಾಗಿ:',
  },
}
